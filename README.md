...
`nation strength status` 显示同一快照中的 Effective Citizen basis points、有效人数、人口当量、30 天可审计活动 basis points、接受/排除计数、总国力和新铸币暂停状态。生产/基础设施、Effective Territory 和合规仍明确为 `PAUSED_ANOMALY`，不会被伪装成可信零值。
